...
namespace SteamSharp.Helpers.Cryptography {
	...
	public class UniversePublicKeys {

		private static Dictionary<SteamUniverse, byte[]> publicKeys = new Dictionary<SteamUniverse, byte[]>() {

			{ SteamUniverse.Unknown, null },

			{ SteamUniverse.Public, new byte[]
				{
			...
			{ SteamUniverse.Internal, new byte[]
				{
					0x30, 0x81, 0x9D, 0x30, 0x0D, 0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x01, 
